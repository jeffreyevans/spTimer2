...
//     n1 = *n;
     ...
     wp = (double *) malloc((size_t)((m1*r1)*sizeof(double))); 
     w0p = (double *) malloc((size_t)((m1)*sizeof(double))); 
     ...
     w01 = (double *) malloc((size_t)((m1)*sizeof(double))); 
     w1 = (double *) malloc((size_t)((m1*r1)*sizeof(double))); 
